        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HoraChegada = table.Column<TimeSpan>(type: "time(6)", nullable: true),
                    HoraSaida = table.Column<TimeSpan>(type: "time(6)", nullable: true),
                    HorasTrabalhadas = table.Column<TimeSpan>(type: "time(6)", nullable: true)
                },
                constraints: table =>
                {
